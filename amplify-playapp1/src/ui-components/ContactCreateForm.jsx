...
export default function ContactCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setAllowed_actions(initialValues.allowed_actions);
    setCurrentAllowed_actionsValue("");
    setOk_to_bid(initialValues.ok_to_bid);
    setSecondary_phone(initialValues.secondary_phone);
    setSecondary_email(initialValues.secondary_email);
    ...
    setPrimary_email(initialValues.primary_email);
    ...
    setContacttypesID(initialValues.contacttypesID);
    setCurrentContacttypesIDValue(undefined);
    setCurrentContacttypesIDDisplayValue("");
    setBid_email(initialValues.bid_email);
    setBid_phone(initialValues.bid_phone);
    setErrors({});
  };
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          const modelFieldsToSave = {
            ...
            secondary_phone: modelFields.secondary_phone,
            secondary_email: modelFields.secondary_email,
            website: modelFields.website,
            primary_email: modelFields.primary_email,
            contacttypesID: modelFields.contacttypesID,
            bid_email: modelFields.bid_email,
            bid_phone: modelFields.bid_phone,
          };
          const contact = (
            await client.graphql({
